...
vi.mock('@/components/projects/forms/create/CreateDevelopmentPlanForm', () => ({ default: () => null }))
vi.mock('@/components/projects/forms/create/CreatePreliminaryPlatForm', () => ({ default: () => null }))
vi.mock('@/components/projects/forms/create/CreateSitePlanForm', () => ({ default: () => null }))
...
describe('FormTypeMap', () => {
  ...
  it('has entries for all 3 form types', () => {
