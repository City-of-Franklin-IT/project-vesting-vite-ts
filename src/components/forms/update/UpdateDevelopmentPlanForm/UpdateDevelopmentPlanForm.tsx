...
import { UpdateDevelopmentPlanFormProps, UpdateDevelopmentPlanFormState } from "./types"
...
function UpdateDevelopmentPlanForm({ data }: UpdateDevelopmentPlanFormProps) {
  ...
  const { register, handleSubmit, watch, reset, setValue, formState: { errors } } = useForm<UpdateDevelopmentPlanFormState>({
    defaultValues: {
        ...
        <div className={styles.body}>
          ...
          <section className="flex gap-3">
            <div className={`${ styles.inputSection } w-1/2`}>
              ...
              {dates.tenYear.date && !values.expired && (
                <DeleteBtn
          ...
          <section className="flex">
            <div className={`${ styles.groupedSection } flex-row mb-8 justify-evenly flex-wrap`}>
              <div className={styles.inputSection}>
                ...
                {dates.initialNotification.date && !values.expired && (
                  <DeleteBtn
